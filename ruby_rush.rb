...
args = Args.new ARGV
srand(args.seed)
location = Location.new('Enumerable Canyon', 1, 1)
...
location.add_neighbors [duck_type_beach, monkey_patch_city]
duck_type_beach.add_neighbors [location, matzburg]
monkey_patch_city.add_neighbors [nil_town, location, matzburg]
